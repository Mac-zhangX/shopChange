<template>
  <div style="padding:1rem">
    ...
    >
      ...
      <el-table-column prop="province" label="归属地（省）" width="200" />
      <el-table-column prop="city" label="归属地（市）" width="200" />
      <el-table-column prop="commission" label="佣金余额" width="200" />
...
export default {
  ...
  methods: {
    ...
    getList() {
      // console.log('----')
      // 查询所有的订单信息
      this.$axios.post(UrlHelper.userManage.getList, {
      ...
      //  console.log(val)
        ...
        //  console.log(val.data.rows)
          // val.data.rows.map(val1 => {
          //   // 获取号码suoziadi
          //   const num = parseInt(val1.phone)
          //   this.$axios.get('/api/dianhua_api/open/location?tel=' + num).then(val2 => {
          //     if (val2.status === 200) {
          //       console.log('val2')
          //       console.log(val2)
          //       val1.province = val2.data.response[num].detail.province
          //       val1.city = val2.data.response[num].detail.area[0].city
          //     }
          //   })
          // })
