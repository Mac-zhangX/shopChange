...
import { login, menuList } from '../../api/modeList'
...
export default {
  ...
  methods: {
    ...
    handleLogin() {
      ...
      formData.append('password', this.loginForm.password.trim());
      login(formData).then((res) => {
        if (res.data.code == 0) {
          ...
          const statusInfo = sessionStorage.setItem('statusInfo', status);
          localStorage.setItem('author', this.loginForm.username);
